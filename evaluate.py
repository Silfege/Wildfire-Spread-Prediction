...
KAGGLE_INPUT_AUG = '/kaggle/input/next-day-wildfire-spread-north-america-2012-2023'
LOCAL_INPUT = '../dataset/next-day-fire'
LOCAL_INPUT_AUG = '../dataset/next-day-fire-2012-2023/northamerica_2012-2023'

# Datasets
if use_augmented:
    if os.path.exists(KAGGLE_INPUT_AUG):
        BASE_DATA_PATH_AUG = KAGGLE_INPUT_AUG
    else:
...
# Select config based on number of input features
